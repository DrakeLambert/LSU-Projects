...
public class UserRegistrationServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (name.isEmpty() || email.isEmpty() || location.isEmpty() || gender == null || experience.isEmpty() || fileName.isEmpty() || filePart == null) {
			out.println("Your input information is not complete, try again <a href=\"/UserRegistrationProject/UserRegistration.html\">go back</a>");
		} else {
			/*
			...
			OutputStream fileout = new FileOutputStream("C:\\Users\\Administrator\\workspace\\UserRegistrationProject\\WebContent\\" + fileName);
			...
			out.println("<!DOCTYPE html>\n" +
					...
					"    </ul>\n" +
					"    <img src=\"/UserRegistrationProject/" + fileName + "\">" +
					"</body>\n" +
					"</html>\n");
		}
	}
